...
// function Main({ data }) {
//   return (
//     <div className=" hide-scrollbar font-roboto lg:h-[calc(100vh-108px)] md:h-[calc(100vh-108px)] lg:overflow-y-scroll md:overflow-y-scroll   md:hide-scrollbar  lg:hide-scrollbar dark:bg-zinc-900 md:col-span-2 lg:col-span-3 justify-self-center  w-full md:p-2  p-4">
...
//                 <p className="dark:text-gray-300 lg:text-4xl lg:flex lg:flex-col  lg:p-1 lg:place-items-start">
//                   {roundOff(data?.pollution?.list[0]?.components?.pm2_5)}
//                   <span className="dark:text-gray-500 text-sm lg:text-xl">
//                     PM25
//                   </span>
//                 </p>{" "}
//                 <p className="dark:text-gray-300 lg:text-2xl lg:flex lg:flex-col  lg:p-1 lg:place-items-start">
//                   {data?.pollution?.list[0]?.components?.no2}
//                   <span className="dark:text-gray-500 text-sm lg:text-lg">
//                     N02
//                   </span>
//                 </p>
//               </div>
...
//                     <p className="text-lg opacity-80    dark:opacity-25">
//                       Sunrise
//                     </p>
